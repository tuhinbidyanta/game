...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        if (item.style.backgroundColor == 'green' && item.innerText.length == 0) {
            ...
            document.querySelectorAll('.box').forEach(i => {
                if (i.style.backgroundColor == 'pink') {
                    ...
                    // let tuhin = document.getElementById(pinkId).innerText
                    if(pinkText != ""){
                        console.log()
                    }
        ...
        if (tog % 2 !== 0) {
            document.getElementById('tog').innerText = "now WHIIE's Turn"
            whosTurn('W')
        }
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "now BLACK's Turn"
            whosTurn('B')
        }
